...
<div id="app">
    <div class="main-wrapper">
        {{-- Navbar --}}
            @include('layouts.admin.dashboard.partials.navbar')
        {{-- End Navbar --}}
        {{-- Sidebar --}}
        ...
        <div class="main-content">
            ...
            {{-- Breadcrumb --}}
            @include('layouts.admin.dashboard.partials.breadcrumb')
            {{-- For Content --}}
            @yield('content')
            </section>
        </div>
  ...
  <script src="{{ asset('assets/back/js/page/bootstrap-modal.js') }}"></script>
</body>
</html>
